...
public class BookMyShow 
{
  public static void main(String[] args) throws InterruptedException, IOException 
  {
		...
		String text = driver.findElement(By.xpath("//div[text()='Subtitles Language']//following::a[1]")).getText();
		...
		//To click on info of theater
		driver.findElement(By.xpath("//div[text()='Subtitles Language']//following::a[6]//following::div[2]")).click();
		Thread.sleep(3000);
	    ...
	    driver.findElement(By.xpath("//div[text()='Subtitles Language']//following::a[7]")).click();
	    Thread.sleep(2000);
	    ...
	    driver.findElement(By.xpath("//div[@id='layout']/table/tbody/tr[9]//div[16]")).click();
	    Thread.sleep(2000);
